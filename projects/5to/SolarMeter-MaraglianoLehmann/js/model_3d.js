...
document.addEventListener('DOMContentLoaded', function() {
    ...
    camera.position.set(13, 425, -14);  // x, y, z (posición cámara)
    controls.target.set(13, 418, -14);  // x, y, z (vista)
    controls.update();
    ...
    loader.load('./models/MedidosRadiacionsolar.stl', function (geometry) {
