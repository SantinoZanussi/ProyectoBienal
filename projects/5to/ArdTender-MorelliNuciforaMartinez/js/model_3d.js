...
document.addEventListener('DOMContentLoaded', function() {
    ...
    camera.position.set(-14.34,-956.04,98.19)  // x, y, z (posición cámara)
    controls.target.set(-14.41,-558.53,43.03);  // x, y, z (vista)
    controls.update();
    ...
    loader.load('./models/Modelo_3d_ArdTender_(FINAL).stl', function (geometry) {
